...
namespace WebApp.Logger.Test.Extensions
{
    ...
    public class LogOptionExtensionTest
    {
        ...
        public void LogOptionExtentionTest_SkipRequest_Valid()
        {
            ...
            //var httpContext = Mock.Of<HttpContext>(_ => _.Request == mockHttpRequest.Object);
            mockHttpContext.Setup(hc => hc.Request).Returns(mockHttpRequest.Object);
            //mockHttpContext.Setup(hc => hc.Request.GetDisplayUrl()).Returns(new Uri("home", UriKind.Relative).AbsoluteUri);
            //mockHttpContext.Setup(hc => hc.Request.Method).Returns("GET");
            //mockHttpContext.Setup(hc => hc.Request.GetEncodedUrl()).Returns(new Uri("/home", UriKind.Relative).AbsoluteUri);
